<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ITSEResult.aspx.cs" Inherits="Public_ITSEResult" %>
	...
	<tr>
		...
		<div id="searchResultDiv">
         <table border="0" align="center" class="tablebgcolor" style="border:solid 0px #999999; width:550px;">
		  <tbody>
          <tr>
          <th align="left" style="font-size:16px;" colspan="2">Congratulations
          </th>
          </tr>
				<tr class="tablebody"><td colspan="2">&nbsp;</td>
                </tr>
                <tr>
                <td>
                <div>
                ...
                <br/> & Your ITSE - <b><asp:Label ID="LblYear" runat="server" Text=""></asp:Label></b>  Rank is <b><asp:Label ID="lblRank"  runat="server" Text=""></asp:Label></b>
                <br />
                You won <b><asp:Label ID="lblPrice"  runat="server" Text=""></asp:Label></b><br />
                Venue & Date Of Celebration When you will receive Prizes and Scholarships will be informed soon through SMS
				...
				<tr class="tablebody"><td colspan="2">&nbsp;</td></tr>
			<%--	<tr class="tablebody"><td align="center" colspan="2"><a href="#">Back to Results</a></td></tr>--%>
				</tbody></table>


                  </div>
		  <div class="class1" style="margin:30px 0px 0px 0px;"></div>
				</td>
				</tr>
				<tr>
					<td colspan="3">&nbsp;</td>
				...
				<div class="copyrighttxt">Idea Learning Academy, Kurukshetra, India. All rights reserved.<br>Website designed &amp; maintained by <a href="#" class="copyrighttxt">Rakesh Panchal</a></div>
					</td>
				</tr>
			</tbody></table>
					</td>
