<%@ Page Title="" Language="C#" MasterPageFile="~/Public/MasterPage.master" AutoEventWireup="true" CodeFile="JEEMainsTopper.aspx.cs" Inherits="Public_JEEMainsTopper" %>
...
<div class="wrapper row3">
  <div id="container">
    ...
    <div id="gallery" class="three_quarter first">
            <h2 class="HeadingLable">JEE Mains Toppers</h2>
       <div class="NavHero">
     ...
     <div class="NavToppers">
          <h2 class="HeadingLableTopper">Other Toppers of JEE Mains</h2>
