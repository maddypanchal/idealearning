<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Employee.master" AutoEventWireup="true" CodeFile="Syllabus.aspx.cs" Inherits="Employee_Syllabus" %>
    ...
    <div style="height:20px;"></div>
        ...
        <div class="one_half">
         ...
         <label for="author">
                            ...
                            <br>
                          <asp:TextBox ID="txtTitleDate" runat="server" placeholder="Enter Date" Text=""  ></asp:TextBox>
                        </label>
       ...
       <div class="">
         ...
         <div class="form-input clear" >
          <div class="one_half">
            <asp:Button ID="btnSave" runat="server" Text="ADD" CssClass="button large gradient orange" OnClick="btnSave_Click" />
            </div>
