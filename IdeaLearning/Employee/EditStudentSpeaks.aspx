<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Employee.master" AutoEventWireup="true" CodeFile="EditStudentSpeaks.aspx.cs" Inherits="Employee_EditStudentSpeaks" %>
    ...
    <table width="1000px" cellpadding="2"  style="float:left; margin:20px 0 20px 0;" cellspacing="10" bgcolor="#333" >
             <tr>
                <td align="center" colspan="3">
                 <asp:Label ID="lblMsg" runat="server" CssClass="footer_title" Text=" Update Student Speaks Details"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="3">
            ...
            <tr>
             <td class="tdMarginLeft">
               Gallery Images 
                ...
                <td>
                <asp:Image ID="imgUser" runat="server" Height="250" Width="800" ImageUrl="~/UploadedFile/Defultuser.png" />
                <br />
