<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Employee.master" AutoEventWireup="true" CodeFile="GalleryDetails.aspx.cs" Inherits="Employee_GalleryDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div id="container">
    ...
    <section class="clear">
      ...
      <p  > <b style="text-transform: uppercase;"> DETAILS OF Gallery</b></p>
     </div>
      </div>
...
<div class="Master_Contect_Heading">
     ...
     <asp:Button ID="btnAddNew" runat="server" Text="Add Gallery"  class="button large gradient orange"
      PostBackUrl="~/Employee/AddGallery.aspx" /></div>
     </div>
      <div style="height:20px;"></div>
         ...
         <%--       <asp:TemplateField HeaderText="Event Date">
                ...
                <asp:TemplateField HeaderText="Description">
                  ...
                  <asp:TemplateField HeaderText="Image Name">
                      ...
                      <a href="../Employee/Toppers/ImgMain/<%#Eval("ImageName") %>" target="_blank" title="Download Images">

                         <img src="../Employee/Toppers/ImgMain/<%#Eval("ImageName")%>" alt="" style="width:160px; height:125px; border: 1px solid #e6e6e6" />
