<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Employee.master" AutoEventWireup="true" CodeFile="ShowDristhiResult.aspx.cs" Inherits="Employee_ShowDristhiResult" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div id="container">
      ...
      <p  > <b style="text-transform: uppercase;"> <asp:Label ID="lblResults" runat="server" text="RESULTS DETAILS"></asp:Label></b></p>
     </div>
      </div>
