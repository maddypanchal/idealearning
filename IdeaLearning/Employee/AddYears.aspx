<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Employee.master" AutoEventWireup="true" CodeFile="AddYears.aspx.cs" Inherits="Employee_AddYears" %>
    ...
    <table width="1000px" cellpadding="2"  style="float:left; margin:20px 0 20px 0;" cellspacing="10" bgcolor="#333" >
             <tr>
                <td align="center" colspan="3">
                 <asp:Label ID="lblMsg" runat="server" CssClass="footer_title" Text=" Add Year's Details"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="3">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtYears" runat="server" Text="" CssClass="message_anyquery_form_news"></asp:TextBox>
               </td>
            </tr>
             <tr>
            ...
            <asp:GridView ID="gvDetail1" runat="server" AutoGenerateColumns="False" DataKeyNames="YearId"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Year Name">
                    <ItemTemplate>
                        <asp:Label ID="lblYearName" runat="server" Text='<%#Eval("YearName") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
