<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="SyllabusDetails.aspx.cs" Inherits="Admin_SyllabusDetails" %>
  ...
  <div id="container">
    ...
    <section class="clear">
     ...
     <asp:Button ID="btnAddNew" runat="server" Text="Add Syllabus"  class="button large gradient orange"
      PostBackUrl="~/Admin/Syllabus.aspx" /></div>
     ...
     <asp:GridView ID="gvDetail1" runat="server" AutoGenerateColumns="False" DataKeyNames="SyllabusId"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Date">
                 ...
                 <asp:TemplateField HeaderText="Name of Mentor">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Content" HeaderStyle-Width="600px" >
                    <ItemTemplate>
                 ...
                 <asp:TemplateField HeaderText="Edit">
                             <ItemTemplate>
                                <a href="EditSyllabus.aspx?Sid=<%#Eval("SyllabusId") %>">Edit
                             </ItemTemplate>
                         </asp:TemplateField>
