<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Employee.master" AutoEventWireup="true" CodeFile="AddCountry.aspx.cs" Inherits="Employee_AddCountry" %>
...
<div class="page">
    ...
    <div class="Contact_GridView">
           <asp:GridView ID="gvDetail1" runat="server" AutoGenerateColumns="False" DataKeyNames="CountryId"
            ...
            <Columns>
                ...
                <EditItemTemplate>
                <asp:TextBox ID="txtUpdateCountry" runat="server" Text='<%#Eval("CountryName") %>'></asp:TextBox>
                   
                </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lblHeadingName" runat="server" Text='<%#Eval("CountryName") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
