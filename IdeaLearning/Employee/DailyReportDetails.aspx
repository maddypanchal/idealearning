<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Employee.master" AutoEventWireup="true" CodeFile="DailyReportDetails.aspx.cs" Inherits="Employee_DailyReportDetails" %>
...
<table   >
          ...
          <%--        
                ...
                <asp:TemplateField HeaderText="View Details">
                             <ItemTemplate>
                               <a href="DailyReport.aspx?Sid=<%#Eval("EmployeeId") %>">Task Details</a>
                             </ItemTemplate>
                         </asp:TemplateField>
