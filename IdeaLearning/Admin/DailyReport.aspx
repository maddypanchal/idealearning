<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="DailyReport.aspx.cs" Inherits="Admin_DailyReport" %>
            ...
            <Columns>
              ...
              <%--  <asp:TemplateField HeaderText="Name">
               ...
               <%--   <asp:TemplateField HeaderText="EmployeeId">
                    <ItemTemplate>
                        <asp:Label ID="lblEmployeeId" runat="server" Text='<%#Eval("EmployeeWorkId") %>'/>
                    </ItemTemplate>
                </asp:TemplateField>--%>
