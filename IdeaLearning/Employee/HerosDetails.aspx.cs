...
public partial class Employee_HerosDetails : System.Web.UI.Page
{
    ...
    public void FillHeros()
    {
        DS = obj_topper.DisplayToppersData();
    ...
    {
        obj_topper.HeroId = Convert.ToInt32(gvDetail1.DataKeys[e.RowIndex].Values["HeroId"].ToString());
        RecordStatus = obj_topper.DeleteHerosImage();
        FillHeros();
    }
