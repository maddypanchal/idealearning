<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="StudentDetails.aspx.cs" Inherits="Admin_StudentDetails" %>
       ...
       <%-- <asp:Button ID="btnAddNew" runat="server" Text="Add Student"   class="button large gradient orange" PostBackUrl="~/Employee/AddStudent.aspx" />--%>
        ...
        <label for="author">
         ...
         <div class="one_fifth">
          <label for="author">
                            ...
                            <br>
                               <asp:TextBox ID="txtName" runat="server" Text="" CssClass="" ValidationGroup="aa"></asp:TextBox>
        ...
        <div class="one_fifth">
          <label for="author">
                            ...
                            <br>
                               <asp:TextBox ID="txtMobile" runat="server" Text="" CssClass="" ValidationGroup="aa"></asp:TextBox>
        ...
        <div class="one_fifth">
          <label for="author">
                            ...
                            <br>
                               <asp:TextBox ID="txtRegistration" runat="server" Text="" CssClass="" ValidationGroup="aa"></asp:TextBox>
        ...
        <asp:Button ID="Button1" runat="server" Text="PRINT" ValidationGroup="bb"  PostBackUrl="~/Admin/StudentPrint.aspx"
