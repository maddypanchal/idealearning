<%@ Page Title="" Language="C#" MasterPageFile="~/Public/MasterPage.master" AutoEventWireup="true" CodeFile="Gallery.aspx.cs" Inherits="Public_Gallery" %>
    ...
    <div style="height:20px;"></div>
     ...
     <%--     <h2>Gallery Title Goes Here</h2>--%>
          ...
          <asp:DataList ID="dtListCategoryTopers" runat="server" RepeatColumns="2" RepeatDirection="vertical">
                        <ItemTemplate>
                            <ul class="gallery clearfix first">
                                <li>
                                    <figure><a  href="../Employee/Toppers/<%#Eval("ImageName")%>" data-gal="prettyPhoto[prettyPhoto]">
                                    <img src="../Employee/Toppers/ImgMain/<%#Eval("ImageName")%>" alt="" class="lightbox-image" style="border: 2px solid #4B759F;
border-radius: 5% 5% 0% 0% ;"  /></a></figure>
                                    <%--<p> <asp:Label ID="lblNametoppers" runat="server" Text='<%# Eval("TitleName")%>'></asp:Label></p>--%>
                                   <p> <asp:Label ID="Label1" runat="server" CssClass="lblGallery" Text='<%# Eval("Description")%>'></asp:Label> </h1></p>
                                </li>
                            </ul>
                        </ItemTemplate>
                    </asp:DataList>
