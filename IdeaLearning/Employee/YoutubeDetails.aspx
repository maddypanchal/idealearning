<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Employee.master" AutoEventWireup="true" CodeFile="YoutubeDetails.aspx.cs" Inherits="Employee_YoutubeDetails" %>
    ...
    <table width="1000px" cellpadding="2"  style="float:left; margin:20px 0 20px 0;" cellspacing="10" bgcolor="#333" >
             <tr>
                <td align="center" colspan="3">
                 <asp:Label ID="lblMsg" runat="server" style="text-transform: uppercase;" CssClass="footer_title" Text=" Add Link's Details"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="3">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtLink" runat="server" Text="" CssClass="message_anyquery_form_news"></asp:TextBox>
               </td>
            </tr>
            <tr>
            ...
            <asp:GridView ID="gvDetail1" runat="server" AutoGenerateColumns="False" DataKeyNames="YoutubeId"
            ...
            <Columns>
                ...
                <EditItemTemplate>
                <asp:TextBox ID="txtUpdateLink" runat="server" Text='<%#Eval("Link") %>'></asp:TextBox>
                </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lblHeadingName" runat="server" Text='<%#Eval("Link") %>' />
                    </ItemTemplate>
                    </asp:TemplateField>
