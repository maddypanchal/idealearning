<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Employee.master" AutoEventWireup="true" CodeFile="ClassCourses.aspx.cs" Inherits="Employee_ClassCourses" %>
...
<table width="1000px" cellpadding="2"  style="float:left; margin:20px 0 20px 0;" cellspacing="10" bgcolor="#333" >
            ...
            <asp:GridView ID="gvDetail1" runat="server" AutoGenerateColumns="False" DataKeyNames="ClassCoursesId"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Courses Name">
                    <ItemTemplate>
                    <asp:Label ID="lblSubjectName" runat="server" Text='<%#Eval("CoursesName") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
