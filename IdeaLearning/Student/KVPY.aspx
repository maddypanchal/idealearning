<%@ Page Title="" Language="C#" MasterPageFile="~/Student/Student.master" AutoEventWireup="true" CodeFile="KVPY.aspx.cs" Inherits="Student_KVPY" %>
                ...
                <asp:TemplateField HeaderText="RegNo">
                 ...
                 <asp:TemplateField HeaderText="Mm Phy">
                  ...
                  <asp:TemplateField HeaderText="Mm Che">
                   ...
                   <asp:TemplateField HeaderText="MoMath">
                    <ItemTemplate>
                        <asp:Label ID="lblMoBio" runat="server" Text='<%#Eval("MoMath") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
