<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Employee.master" AutoEventWireup="true" CodeFile="HerosDetails.aspx.cs" Inherits="Employee_HerosDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <div id="container">
    ...
    <section class="clear">
      ...
      <p> <b style="text-transform: uppercase;"> Details of Heors</b></p>
      </div>
      </div>
      </section>
...
<div class="Master_Contect_Heading">
    ...
    <div>
    <asp:Button ID="btnAddNew" runat="server" Text="Add Heors"  class="button large gradient orange"
      PostBackUrl="~/Employee/AddHeros.aspx" /></div>
    </div>
     <div style="height:20px;"></div>
    <div class="Contact_GridView">
    <asp:GridView ID="gvDetail1" runat="server" AutoGenerateColumns="False" DataKeyNames="HeroId"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Name">
                  ...
                  <asp:TemplateField HeaderText="Roll Number">
                   ...
                   <asp:TemplateField HeaderText="Heor Image">
                      <ItemTemplate>
