...
public partial class Employee_SendSmsHomeWork : System.Web.UI.Page
{
    #region "Variable Decleration"
    private clsMaster obj_Master = new clsMaster();
    private DataSet DS;
    private int RecordStatus;
    private static int HomeWorkId;
    ...
    {
        HomeWorkId = int.Parse(Request.QueryString["Sid"]);
        if (!IsPostBack)
        {
    ...
    {
        obj_Master.HomeWorkId = HomeWorkId; 
    
        DS = obj_Master.FillHomeWopkId();
...
private void SendSMSHomepage()
    ...
    {
        Response.Redirect("HomeWorkDetails.aspx", false);
    }
}