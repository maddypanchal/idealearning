<%@ Page Title="" Language="C#" MasterPageFile="~/Student/Student.master" AutoEventWireup="true"
    CodeFile="ExamInfo.aspx.cs" Inherits="Student_ExamInfo" %>
        ...
        <div class="wrapper">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Subject">
                    <ItemTemplate>
                        <asp:Label ID="lblSubjectName" runat="server" Text='<%#Eval("classSubject") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <%--<asp:TemplateField HeaderText="Send SMS">
                             <ItemTemplate>
                                <a href="SendSmsExamInfo.aspx?Sid=<%#Eval("ExamInfoId") %>">Send
                             </ItemTemplate>
                 </asp:TemplateField>--%>
        ...
        <asp:GridView ID="gvDetail1" runat="server" AutoGenerateColumns="False" DataKeyNames="ExamInfoId"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Type Of Test">
                    ...
                    <asp:TemplateField HeaderText="Venue">
                    <ItemTemplate>
                        <asp:Label ID="lblTypeOfTest" runat="server" Text='<%#Eval("Venue") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
