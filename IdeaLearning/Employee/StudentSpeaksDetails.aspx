<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Employee.master" AutoEventWireup="true" CodeFile="StudentSpeaksDetails.aspx.cs" Inherits="Employee_StudentSpeaksDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <div id="container">
    ...
    <section class="clear">
      ...
      <p><b> STUDENT SPEAKS DETAILS</b></p>
      </div>
      </div>
     ...
     <div class="Master_Contect_Heading">
      <div>
     <asp:Button ID="btnAddNew" runat="server" Text="Add Student Speaks"  class="button large gradient orange"
      PostBackUrl="~/Employee/AddStudentSpeaks.aspx" /></div>
     </div>
      <div style="height:20px;"></div>
    <div class="Contact_GridView">
     <asp:GridView ID="gvDetail1" runat="server" AutoGenerateColumns="False" DataKeyNames="StudentSpeaksId"
                ...
                <asp:TemplateField HeaderText="Description">
                  ...
                  <asp:TemplateField HeaderText="Image Name">
                      ...
                      <a href="../Employee/Toppers/<%#Eval("ImageName") %>" target="_blank" title="Download Images">
                         ...
                         <img src="../Employee/Toppers/<%#Eval("ImageName")%>" alt="" style="width:560px; height:125px; border: 1px solid #e6e6e6" />
                 ...
                 <asp:TemplateField HeaderText="Edit">
                             <ItemTemplate>
                                <a href="EditStudentSpeaks.aspx?Sid=<%#Eval("StudentSpeaksId") %>">Edit
                             </ItemTemplate>
                         </asp:TemplateField>
